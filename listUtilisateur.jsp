       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="index.html">
                  <img width="150" height="150" src="./assets/TemplateAdmin/img/iii.png" alt="Admin " />
               </a>
               <!-- END LOGO -->
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <tbody>
                                 ...
                                 <% for(Utilisateur u : list) { %>
                                      <tr class="odd gradeX">
                                         ...
                                         <td><%= u.getEmail() %> </td>
                                         <td><%= u.getRole() %> </td>
                                         <td> <a href="User?id=<%= u.getId()%>&action=delete"> <input  type="button" value="Delete"> </a> <a href="User?id=<%= u.getId()%>&action=edit"> <input class="btn btn-success"  type="button" value="Edit"> </a></td>
                         ...
                         <br>
                         <a href="addutilisateur.jsp"> <input  type="button" value="Add">
                        </div>
                    </div>
