       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="index.html">
                   <img width="150" height="150" src="./assets/TemplateAdmin/img/iii.png" alt="Admin Lab" />
               </a>
               <!-- END LOGO -->
         ...
         <div class="container-fluid">
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Products</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
            ...
            <div class="row-fluid">
             ...
             <tr>
                ...
                <td> <a href="Produit?id=<%= u.getId()%>&action=delete"> <input  type="button" value="Delete"> </a> <a href="Produit?id=<%= u.getId()%>&action=edit"> <input class="btn btn-success" type="button" value="Edit"> </a></td>
            ...
            <%} %>
                        ...
                        <br>
      <a href="addproduit.jsp"> <input class="btn btn-success"  type="button" value="Add"> </a>
                        </div>
                    </div>
